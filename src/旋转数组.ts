/*
 * @Author: zhangyang micyounian@foxmail.com
 * @Date: 2022-09-24 10:32:38
 * @Description: 数组旋转
 */
...
export function rotate_simple(arr: number[], k: number): number[] {
    if (k < 0) throw new Error('k不能小于零')
